...
static_assert(BS_COUNT_OPS == 75, "Update bs_debug_op()");
void bs_debug_op(Bs_Pretty_Printer *p, const Bs_Chunk *c, size_t *offset) {
    ...
    case BS_OP_PANIC:
        bs_fmt(p->writer, "OP_PANIC\n");
        break;

    case BS_OP_ASSERT:
        bs_fmt(p->writer, "OP_ASSERT\n");
        break;
